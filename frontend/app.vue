<template>
  ...
  <NuxtLink to="/" class="font-semibold text-heading">Mental Asistanım</NuxtLink>
  ...
  <h1 class="font-semibold text-sm sm:text-base">Mental Asistanım</h1>
...
const avatarUrl = ref<string>('https://via.placeholder.com/64')
